...
public class BackofficeRejectionOrderQtySheetBean implements Serializable, CSVMapping {
	...
	public static BackofficeRejectionOrderQtySheetBean newInstance() {
		return new BackofficeRejectionOrderQtySheetBean();
	}
	...
	@Override
	public BackofficeRejectionOrderQtySheetBean newBean() {
		return newInstance();
	}
